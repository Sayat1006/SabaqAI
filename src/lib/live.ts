...
export const LIVE_TEXT = {
  ...
  en: {
    ...
    points: "points",
    place: "place",
    rank: (n: number) => `${n}${n % 10 === 1 && n % 100 !== 11 ? "st" : n % 10 === 2 && n % 100 !== 12 ? "nd" : n % 10 === 3 && n % 100 !== 13 ? "rd" : "th"} place`,
    name: "Your name",
    namePh: "e.g. Aigerim S.",
    codePh: "6-digit code",
    enter: "Join",
    youAreIn: "You’re in!",
    waitStart: "Wait for the teacher to start the game",
    ...
    leave: "Join another game",
    liveQuiz: "Live quiz",
    hint: (n: number, t: number) => `${n} questions · ${t} seconds each. Faster correct answers earn more points (500–1000).`,
    errors: {
      not_found: "Game not found or already finished. Check the code.",
      name_taken: "That name is taken — add your surname initial.",
      full: "The game is full.",
      bad_name: "Enter your name (at least 2 letters).",
